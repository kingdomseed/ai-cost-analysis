...
type SnapshotKind = "pricing" | "entitlements" | "fx" | "models";
...
export async function loadLatestModelsSnapshot(): Promise<{ date: string; data: unknown }> {
  return loadLatestSnapshot("models");
}
